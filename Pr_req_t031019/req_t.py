...
model = joblib.load('modelPR_111119.pkl')
count_vect = joblib.load('c_vectPR_111119.pkl')


with open('cl_reportPR_111119.txt', 'r') as file:
    cl_report=file.read()

with open('cconf_matrix_Model_to_service_111119.txt', 'r') as file:
